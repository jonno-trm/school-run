    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-6 bg-gradient-to-b from-brand-600 to-brand-700">
      <div className="w-full max-w-sm">
        <div className="flex flex-col items-center mb-10">
          ...
          <p className="text-blue-100 mt-1 text-sm">You've been invited to help</p>
        </div>

        <div className="bg-white rounded-2xl shadow-2xl p-6">
          <h2 className="text-lg font-semibold text-slate-800 mb-1">Join the roster</h2>
          <p className="text-sm text-slate-500 mb-5">Just your name to get started.</p>
